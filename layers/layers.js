...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_Locationscores_1.setVisible(true);lyr_Provinces_2.setVisible(true);lyr_Kinshasa_3.setVisible(true);lyr_PlannedsitesKinshasa_4.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_Locationscores_1,lyr_Provinces_2,lyr_Kinshasa_3,lyr_PlannedsitesKinshasa_4];
...
lyr_PlannedsitesKinshasa_4.on('precompose', function(evt) {
